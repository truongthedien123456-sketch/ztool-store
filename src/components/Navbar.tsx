...
export default function Navbar() {
  ...
  const VIP_TIERS_DATA = [
    ...
    },
    {
      ...
      icon: Gem,
      color: 'text-purple-300',
      badgeBg: 'bg-gradient-to-r from-purple-500/30 to-indigo-500/30 border-purple-400 text-purple-200 shadow-[0_0_12px_rgba(168,85,247,0.7)]',
      ...
      <nav className="bg-[#080D15]/95 backdrop-blur-2xl border-b border-slate-800/80 sticky top-0 z-40 px-4 sm:px-8 lg:px-12 py-4 sm:py-4.5 shadow-[0_10px_35px_rgba(0,0,0,0.7)] transition-all">
        <div className="max-w-[1550px] mx-auto flex items-center justify-between gap-6">
          ...
          <div className="hidden md:flex items-center gap-2 bg-[#0D131F]/90 border border-slate-800/90 p-1.5 rounded-2xl shadow-inner">
            ...
            {/* NÚT DISCORD GLOW NEON */}
            <a
              href="https://discord.gg/sf8pXrMhPb"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-black text-indigo-200 bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-indigo-500/20 border border-indigo-500/40 hover:border-indigo-400 hover:bg-indigo-600 hover:text-white hover:shadow-[0_0_20px_rgba(99,102,241,0.55)] transition-all duration-300 cursor-pointer group shrink-0"
              title="Tham gia cộng đồng Discord ZTool"
            >
              <svg className="w-4 h-4 fill-current text-indigo-400 group-hover:text-white group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
